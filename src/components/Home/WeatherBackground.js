export const WeatherImages = {
  background: {
    'clear-day': require('../../assets/img/bg/clear-day.png'),
    'clear-night': require('../../assets/img/bg/clear-night.png'),
    'cloudy': require('../../assets/img/bg/cloudy.png'),
    'partly-cloudy-night': require('../../assets/img/bg/partly-cloudy-day.png'),
    'partly-cloudy-day': require('../../assets/img/bg/partly-cloudy-day.png'),
    'rain': require('../../assets/img/bg/rain.png'),
    'sleet': require('../../assets/img/bg/sleet.png'),
    'snow': require('../../assets/img/bg/snow.png'),
    'thunderstorm': require('../../assets/img/bg/thunderstorm.png'),
    'wind': require('../../assets/img/bg/wind.png')
  },
  icons: {
    weather: {
